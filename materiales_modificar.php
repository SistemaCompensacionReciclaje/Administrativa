...
<html lang="en">
  ...
  <head>
    ...
    <title>SB Admin - Modificar Materiales</title>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              ...
              <h3>Modificar Material</h3>
                          ...
                          <form class="form-horizontal">
                            ...
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="IDMaterial">ID Material</label>  
                              <div class="col-md-6">
                              <input id="IDMaterial" name="IDMaterial" type="text" placeholder="" class="form-control input-md" required="">
              ...
              <center><a  class="btn btn-success" href="materiales.php">Modificar
